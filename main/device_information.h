...
typedef enum {
    ...
    DEVICE_VARIANT_COLOR_COMMODORE        = 0x09,
    // Custom color variants (0x80 - 0x8F)
    DEVICE_VARIANT_COLOR_BLACK_PURPLE     = 0x80,
    DEVICE_VARIANT_COLOR_ORANGE_BLACK     = 0x81,
    DEVICE_VARIANT_COLOR_ORANGE_CYBERDECK = 0x82,
    DEVICE_VARIANT_COLOR_WHITE_PURPLE     = 0x83,
    DEVICE_VARIANT_COLOR_BLACK_WHITE      = 0x84,
    DEVICE_VARIANT_COLOR_GREEN_BLUE       = 0x85,
    DEVICE_VARIANT_COLOR_BLACK_GREEN      = 0x86,
    DEVICE_VARIANT_COLOR_WHITE_CYBERDECK  = 0x87,
