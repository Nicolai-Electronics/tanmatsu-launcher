...
key_t keys[] = {
    ...
    {.name = "SPACE", .scancode = BSP_INPUT_SCANCODE_SPACE, .pressed = false, .was_pressed = false, .changed = true},
    {.name = "SPACE", .scancode = BSP_INPUT_SCANCODE_SPACE, .pressed = false, .was_pressed = false, .changed = true},
    {.name = "SPACE", .scancode = BSP_INPUT_SCANCODE_SPACE, .pressed = false, .was_pressed = false, .changed = true},
    {.name        = "V+",
     .scancode    = BSP_INPUT_SCANCODE_ESCAPED_VOLUME_UP,
     .pressed     = false,
     .was_pressed = false,
     .changed     = true},
    {.name        = "V-",
     .scancode    = BSP_INPUT_SCANCODE_ESCAPED_VOLUME_DOWN,
     .pressed     = false,
     .was_pressed = false,
     .changed     = true},
    {.name        = "ALTGR",
